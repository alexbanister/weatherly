...
export default class App extends React.Component {
  ...
  componentDidMount() {
    // myLocation.update(this.updateLocation.bind(this));
    fetch(`http://api.wunderground.com/api/${myLocation.key}/conditions/hourly/forecast10day/q/${myLocation.query}.json`)
      ...
      .then(() => {this.updateLocation();
        // this.setState({
        //   // tenDay: myLocation.dayForecast(),
        //   // hourly: myLocation.hourForecast(),
        //   currentWeather: myLocation.currentConditions(),
        // });
      });
  }
    ...
    return (
      <div id="everything">
        ...
        <CurrentWeather
          ...
          high={this.state.currentWeather.high_c}
